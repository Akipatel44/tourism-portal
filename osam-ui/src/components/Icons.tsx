 ...
 * Replaces emojis with clean, professional icons
 */
...
// Navigation & UI Icons
export const HomeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', size = 24 }) => (
...
export const TemplateIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M10 2H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-6V2" />
...
export const TreeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M12 2L15 8H9L12 2M8 8L13 18M16 8L11 18M6 18H18" />
  </svg>
);
...
export const MountainIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <polygon points="12 2 15 10 8 10 12 2" />
    <polygon points="8 10 2 22 14 22 8 10" />
    <polygon points="14 10 18 18 22 22 14 10" />
  </svg>
);

export const ImagesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
// Activity & Features Icons
export const CompassIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="12" cy="12" r="10" />
    <path d="M16.24 7.76l-6.48 6.48M12 12l4.24-4.24" />
  </svg>
);
...
export const StarIcon: React.FC<IconProps> = ({ className = 'w-5 h-5', filled = true }) => (
  <svg className={className} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2">
    <polygon points="12 2 15.09 10.26 23.77 11.36 17.88 17.15 19.54 25.88 12 21.77 4.46 25.88 6.12 17.15 0.23 11.36 8.91 10.26 12 2" />
  </svg>
);
